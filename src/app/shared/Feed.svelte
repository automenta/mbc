<script lang="ts">
	...
	import {ago, hash, now, uniqBy, WEEK} from "src/lib"
	import type {TrustedEvent} from "src/util"
	import {synced} from "src/store"
	import type {Feed as FeedDefinition, FeedController} from "src/feeds"
	import {isKindFeed, isRelayFeed, makeIntersectionFeed, makeKindFeed, walkFeed} from "src/feeds"
