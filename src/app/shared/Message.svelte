...
<div class="grid gap-2 py-1" in:fly={{y: 20}}>
	<div
					...
					<div class="flex items-center gap-1">
						...
						{#if message.created_at > $timestamp1 - $userSettings.send_delay / 1000}
							<button
							  ...
							  on:click={() => abortThunk(thunk)}>Cancel
							</button>
						{/if}
					</div>
				{:then}
				...
				{#if message.kind === 4}
					<Popover triggerType="mouseenter">
						...
						<p slot="tooltip">
							...
							Read more
							<Anchor underline modal href="/help/nip-44-dms">here</Anchor>
							.
						</p>
					</Popover>
				{:else}
					<Popover triggerType="mouseenter">
						...
						<div slot="tooltip" class="flex flex-col gap-2">
							<p>
								...
								several problems with legacy DMs. Read more
								<Anchor
								  underline
								  modal
								  href="/help/nip-44-dms">here
								</Anchor
								>
								.
							</p>
