<script lang="ts">
	...
	import {getIdOrAddress} from "src/util"
	import type {Thunk} from "src/app"
	import {pubkey, thunks} from "src/app"
...
<div class="group relative">
	<Card class="relative" {interactive} on:click={onClick} stopPropagation>
		{#if pinned}
	...
	<NoteReply {onReplyCancel} {onReplyPublish} parent={event} {replyIsOpen} />
</div>
