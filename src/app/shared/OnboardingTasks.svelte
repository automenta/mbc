...
<OnboardingTaskComponent task={OnboardingTask.BackupKey}>
	...
	<p>
		We recommend storing your key in a password manager like
		<Anchor
		  external
		...
		>
		, and logging in to other apps only using a signer extension like
		<Anchor
		  external
...
{#if env.ENABLE_ZAPS}
	<OnboardingTaskComponent task={OnboardingTask.SetupWallet}>
		...
		<p>
			If you used
			<Anchor external underline href="https://getalby.com/">Alby</Anchor>
			to store your
		...
		<p>
			...
			into your profile settings (click "Edit" in the menu on your profile
