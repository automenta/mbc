<script lang="ts">
	...
	import {ctx, now, uniq, without} from "src/lib"
	import {COMMENT, createEvent, getPubkeyTagValues, NOTE, uniqTags} from "src/util"
	import type {Thunk} from "src/app"
	import {displayProfileByPubkey, session, tagEventForComment, tagEventForReply} from "src/app"
	import {hash, own} from "src/signer"
