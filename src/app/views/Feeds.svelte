<script lang="ts">
	import {makeAuthorFeed, makeRelayFeed, makeScopeFeed, Scope} from "src/feeds"
...
{#if !$pubkey}
	<div class="py-16 text-center">
		...
		<p>
			Click
			<Anchor underline on:click={showLogin}>here</Anchor>
			to join the nostr network.
		</p>
	</div>
{/if}

<Feed {feed} showControls={!isPlatformFeed} />
