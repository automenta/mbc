	...
	<Card>
		<FlexColumn class="py-6 text-center">
			...
			<div class="flex justify-center">
				<Anchor accent button href="/settings/data/export" modal>Create Backup</Anchor>
			</div>
		</FlexColumn>
	</Card>
	<Card>
		<FlexColumn class="py-6 text-center">
			...
			<div class="flex justify-center">
				<Anchor accent button href="/settings/data/import" modal>Upload Backup</Anchor>
			</div>
		</FlexColumn>
	</Card>
</div>
...
<table bind:this={element}>
	...
	{#each events.slice(0, limit) as event}
		<tr>
			...
			<td class="px-2 py-1">
				<PersonBadgeSmall pubkey={event.pubkey} />
			</td>
