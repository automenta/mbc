<script lang="ts">
	...
	import {getNip07, getNip55, Nip07Signer, Nip55Signer} from "src/signer"
...
<div>
	<FlexColumn large narrow>
		<div class="text-center">
			<Heading>Welcome!</Heading>
			<p>
				{appName} is built using the
				<Anchor external href="https://nostr.com/" underline>nostr protocol</Anchor>
				, which allows
		...
		<div class="relative flex flex-col gap-4">
			...
			{/each}
			<Anchor button on:click={useBunker} tall>
				<i class="fa fa-box" /> Use Remote Signer
			</Anchor>
			<Anchor button external href="https://nostrapps.com/#signers" low tall>
				<i class="fa fa-compass" /> Browse Signer Apps
			</Anchor>
		</div>
		<span class="text-center">
      Need an account?
      <Anchor on:click={signUp} underline>Register instead</Anchor>
    </span>
	</FlexColumn>
</div>
