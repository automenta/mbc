<script lang="ts">
	...
	import type {SignedEvent} from "src/util"
	import {asSignedEvent, createEvent} from "src/util"
	import {Nip01Signer, Nip59} from "src/signer"
	import {loadRelaySelections, repository} from "src/app"
...
<form on:submit|preventDefault={submit}>
	<FlexColumn>
		...
		<Field label="Why are you reporting this content?">
			...
			<div slot="info">
				Reports are sent to
				<PersonLink pubkey={tagr} />
				for review. No identifying information is included
				with the report.
			</div>
		</Field>
