...
<p>
	Pick a category to find some people to follow, or click
	<Anchor
	  on:click={openPersonSearch}
	  underline>here
	</Anchor>
...
<div class="flex justify-between">
	...
	<Anchor on:click={openSelections} underline>View selections</Anchor>
</div>
<div class="flex gap-2">
	<Anchor button on:click={prev}><i class="fa fa-arrow-left" /> Back</Anchor>
	<Anchor accent button class="flex-grow" {loading} on:click={next}>Continue</Anchor>
</div>
