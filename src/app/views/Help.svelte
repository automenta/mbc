...
{#if topics.includes(topic)}
	...
	{:else if topic === "remote-signers"}
		...
		<p>
			...
			you're new to nostr, we recommend getting started with
			<Anchor
			  external
			  underline
			  href="https://nsec.app/">nsec.app
			</Anchor
			>
			.
		</p>
	...
	{:else if topic === "nip-17-dms"}
		<p>
			<Anchor underline external href={nip17Url}>NIP 17</Anchor>
			improves upon the old NIP 04 direct
